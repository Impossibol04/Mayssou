        ...
        moderation: [
            ...
            },
            {
                ...
                lines: [
                    ...
                    L(p, 'antiraid', null, 'Pic d’**arrivées** · **quarantine** @rôle · exempt. *Admin.*'),
                    L(p, 'tribunal', 'tribunal', 'Vote **punir / absoudre** (2 min) → timeout si punir. *Modérer membres.*'),
        ...
        fun: [
            {
                ...
                hint: 'Jeux & images.',
                lines: [
                    L(p, 'minigames', 'minigames', '**pile** · **dés** · **roulette** · alias **jeux**.'),
                    L(p, 'quiz', 'quiz', '**culture** / **anime** / **gaming** / **mix** · **top** classement.'),
